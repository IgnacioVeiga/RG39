...
- `RandomGameLauncher/Services`: adaptadores de infraestructura y servicios de orquestación de app (repositorio JSON, servicio de catálogo, proveedores Steam/Epic, selector de ejecutable, launcher, servicio de diálogo).
